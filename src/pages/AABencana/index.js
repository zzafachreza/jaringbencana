...
export default function ({ navigation, route }) {
    ...
    const renderItem = ({ item, index }) => (
        <TouchableOpacity onPress={() => navigation.navigate('AABencanaView', item)} style={{
            margin: 10,
            padding: 10,
    ...
    return (
        <>
            ...
            <View style={{
                padding: 10,
            }}><MyButton onPress={() => navigation.navigate('AABencanaAdd')} warna={colors.secondary} colorText={colors.primary} iconColor={colors.primary} title="TAMBAH" Icons="create-outline" />
            </View>
        </>
    );
}
